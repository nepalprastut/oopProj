...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/res/image/e-library.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/res/icon/dashboard-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/res/icon/category-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/res/icon/publication-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/res/icon/book-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icons/res/icon/book-issue-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icons/res/icon/request-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icons/res/icon/register-white.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/icons/res/icon/report-white.png"), QSize(), QIcon::Normal, QIcon::Off);
...
""));
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/images/res/image/menu.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/icons/res/icon/bell.png"), QSize(), QIcon::Normal, QIcon::Off);
...
"}"));
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/icons/res/icon/profile.png"), QSize(), QIcon::Normal, QIcon::Off);
